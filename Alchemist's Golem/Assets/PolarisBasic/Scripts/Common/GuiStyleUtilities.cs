        ...
        public static GUIStyle RightAlignedGrayMiniLabel
        {
            get
            {
                if (rightAlignedGrayMiniLabel == null)
                    rightAlignedGrayMiniLabel = new GUIStyle();
                rightAlignedGrayMiniLabel.normal.textColor = new Color(0.1f, 0.1f, 0.1f, 1f);
                rightAlignedGrayMiniLabel.alignment = TextAnchor.MiddleRight;
                rightAlignedGrayMiniLabel.fontSize = 8;
