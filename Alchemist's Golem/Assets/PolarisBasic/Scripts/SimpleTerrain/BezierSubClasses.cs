...
namespace Pinwheel.PolarisBasic
{
    public partial class Bezier
    {
        ...
        public class ControlPoint
        {
            ...
            /// <summary>
            /// Position of the control point in world space
            /// </summary>
            ...
            /// <summary>
            /// Position of the handles in world space
            /// </summary>
            ...
            public Vector3 SnapHandle(Vector3 handleNewPosition, float snapAngle = 15)
            {
                ...
                float angle = 0;
                float dot = Vector3.Dot(handleDirection, Vector3.forward);
                if (dot >= 0)
                {
                    angle = (dot < 0 ? 180 : 0) + Vector3.Angle(Vector3.right, handleDirection);
                }
                else
                {
                    angle = 180 + Vector3.Angle(Vector3.left, handleDirection);
                }
