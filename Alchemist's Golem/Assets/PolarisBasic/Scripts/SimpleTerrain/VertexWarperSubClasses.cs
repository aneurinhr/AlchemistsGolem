...
namespace Pinwheel.PolarisBasic
{
    public partial class VertexWarper
    {
        ...
        public static class TemplateMaker
        {
            ...
            public static Vector3[] GetDefaultTemplate(float y, float minX, float maxX, float minZ, float maxZ)
            {
                ...
                points[i * controlPointDataCount + 2] = bottomLeft + zOffset;

                i = 1;
                points[i * controlPointDataCount + 0] = topLeft;
                points[i * controlPointDataCount + 1] = topLeft - zOffset;
                ...
                points[i * controlPointDataCount + 2] = topRight - zOffset;

                i = 3;
                points[i * controlPointDataCount + 0] = bottomRight;
                points[i * controlPointDataCount + 1] = bottomRight + zOffset;
